 ...
 * Infraestructura Computacional 201520
...
public class Seguridad {
	...
	public static SecretKey keyGenGenerator(String algoritmo) 
		...
		int tamLlave = 0;
		if (algoritmo.equals(Protocolo.HMACMD5))
			tamLlave = 64;
		else if (algoritmo.equals(Protocolo.HMACSHA1))
			tamLlave = 64;
		else if (algoritmo.equals(Protocolo.HMACSHA256))
			tamLlave = 64;
